...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, AD9833A_FSYNC_Pin|AD9833A_SCLK_Pin|AD9833A_SDATA_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, AD9833B_FSYNC_Pin|AD9833B_SCLK_Pin|AD9833B_SDATA_Pin|ADS8688_RST_Pin
                          |ADS8688_DAISY_Pin|ADS8688_CS_Pin|ADS8688_SCLK_Pin|ADS8688_SDI_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : AD9833B_FSYNC_Pin AD9833B_SDATA_Pin ADS8688_RST_Pin ADS8688_DAISY_Pin
                           ADS8688_CS_Pin ADS8688_SCLK_Pin ADS8688_SDI_Pin */
  GPIO_InitStruct.Pin = AD9833B_FSYNC_Pin|AD9833B_SDATA_Pin|ADS8688_RST_Pin|ADS8688_DAISY_Pin
                          |ADS8688_CS_Pin|ADS8688_SCLK_Pin|ADS8688_SDI_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /*Configure GPIO pin : ADS8688_SDO_Pin */
