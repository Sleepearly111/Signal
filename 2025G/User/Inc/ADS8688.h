 ...
 * PD5 -> ADS8688_SDO
 */
#define ADS8688_RST_H()      HAL_GPIO_WritePin(ADS8688_RST_GPIO_Port, ADS8688_RST_Pin, GPIO_PIN_SET)
#define ADS8688_RST_L()      HAL_GPIO_WritePin(ADS8688_RST_GPIO_Port, ADS8688_RST_Pin, GPIO_PIN_RESET)
#define ADS8688_DAISY_H()   HAL_GPIO_WritePin(ADS8688_DAISY_GPIO_Port, ADS8688_DAISY_Pin, GPIO_PIN_SET)
#define ADS8688_DAISY_L()   HAL_GPIO_WritePin(ADS8688_DAISY_GPIO_Port, ADS8688_DAISY_Pin, GPIO_PIN_RESET)
...
#define ADS8688_SCLK_H()     HAL_GPIO_WritePin(ADS8688_SCLK_GPIO_Port, ADS8688_SCLK_Pin, GPIO_PIN_SET)
#define ADS8688_SCLK_L()     HAL_GPIO_WritePin(ADS8688_SCLK_GPIO_Port, ADS8688_SCLK_Pin, GPIO_PIN_RESET)
#define ADS8688_SDI_H()      HAL_GPIO_WritePin(ADS8688_SDI_GPIO_Port, ADS8688_SDI_Pin, GPIO_PIN_SET)
#define ADS8688_SDI_L()      HAL_GPIO_WritePin(ADS8688_SDI_GPIO_Port, ADS8688_SDI_Pin, GPIO_PIN_RESET)
#define ADS8688_SDO_READ()   HAL_GPIO_ReadPin(ADS8688_SDO_GPIO_Port, ADS8688_SDO_Pin)
