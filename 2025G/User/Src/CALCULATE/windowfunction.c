...
static float Win_Function_Buf[1024];
static uint16_t i = 0;
...
static void triang(uint16_t Length) // 三角�?
{
...
static void hanning(uint16_t Length) // 汉明�?
{
    for (i = 0; i < Length; i++)
    {
...
static void hamming(uint16_t Length) // 海明�?
{
    for (i = 0; i < Length; i++)
    {
...
static void blackman(uint16_t Length) // 布莱克曼�?
{
    for (i = 0; i < Length; i++)
    {
...
static void flattop(uint16_t Length) // 平顶�?
{
    for (i = 0; i < Length; i++)
    {
